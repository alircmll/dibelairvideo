...
nature = Category.create!(name: 'Nature & Voyages', photo: "voyageC.png", icon: "earth.png")
work = Category.create!(name: "Films d'entreprises", photo: "entrep.png", icon: "case.png")
clip = Category.create!(name: 'Clips Vidéos', photo: "clip.png", icon: "record.png")
...
Movie.create!(name: 'Clips Vidéos', yt_url:"https://www.youtube.com/embed/dJuDnrpnmUc", category_id: clip.id)
